...
//             <h2 className="text-xl font-bold">JobSeee</h2>
//             <p className="text-sm">© 2024 JobSeee. All rights reserved.</p>
//           </div>
...
const Footer = () => {
  return (
    <footer className="bg-beige-100 text-gray-800 py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0">
          {/* Brand Section */}
          <div className="text-center md:text-left">
            <h2 className="text-3xl font-bold tracking-wide mb-2">JobSeee</h2>
            <p className="text-sm text-gray-500">© 2024 JobSeee. All rights reserved.</p>
          </div>

          {/* Quick Links */}
          <div className="flex flex-col items-center md:items-start space-y-3">
            <h3 className="text-lg font-semibold text-gray-600">Quick Links</h3>
            <a href="#about" className="text-gray-500 hover:text-gray-700 transition duration-300">About Us</a>
            <a href="#services" className="text-gray-500 hover:text-gray-700 transition duration-300">Services</a>
          </div>

          {/* Contact Info */}
          <div className="flex flex-col items-center md:items-start space-y-3">
            <h3 className="text-lg font-semibold text-gray-600">Contact Us</h3>
            <p className="text-gray-500">support@jobseee.com</p>
